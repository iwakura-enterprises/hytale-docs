---
name: Changelog
description: All the changes made to Voile
author: mayuna
sort-index: 5
---
...
- Added full-text search functionality for topics.
    - Nicely tuned full-text search functionality that works for all interface modes.
...
### Minor
- Added ability to override Hytale commands with command shortcuts (see **Configuration** topic)
