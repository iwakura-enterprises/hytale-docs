...
@Bean
public class VoileDebugCommand extends AbstractPlayerCommand {

    private final DebugService debugService;

    public VoileDebugCommand(DebugService debugService) {
        super("voile-debug", "Shows debug information for Voile. Contains sensitive data about the server.");
