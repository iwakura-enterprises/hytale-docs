...
public class HytaleCommonRenderer implements Renderer<Void> {

    @Override
    public String render(DocsContext ctx, Void data) {
        return
            """
                ...
                // Buttons
                @ButtonSounds = @ButtonsLight;
                @ButtonDestructiveSounds = @ButtonsDestructive;
                ...
                @DefaultCheckBoxStyle = CheckBoxStyle(
                  Unchecked: (
                    ...
                    ChangedSound: (SoundPath: @Untick, Volume: 6)
                  ),
                  Checked: (
                    ...
                    ChangedSound: (SoundPath: @Tick, Volume: 6)
                  )
                );
                ...
                @Container = Group {
                  @ContentPadding = Padding(Horizontal: 10, Bottom: 10, Top: 7);
                  @CloseButton = false;
                ...
                @DefaultSliderStyle = SliderStyle(
                  ...
                  HandleHeight: 16,
                  Sounds: (
                    MouseHover: (SoundPath: @ButtonsLightHover, Volume: 6)
                  )
                );
                
                @BackButton = Group {
                  LayoutMode: Left;
                  Anchor: (Left: 10, Bottom: 10, Width: 110, Height: 27);
